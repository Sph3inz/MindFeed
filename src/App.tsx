  ...
  return (
    <BrowserRouter>
      <div className="flex h-screen w-full overflow-hidden">
        <div className="bg-gradient-to-r from-[#f8efe6] via-[#f3eef4] to-[#e8f3f1] flex flex-1">
          <Sidebar />
          <div className="flex-1 flex flex-col min-h-0">
            <div className="flex flex-1 overflow-hidden">
              ...
              <div className={`fixed right-0 top-0 h-screen w-[450px] transition-transform duration-300 ease-in-out backdrop-blur-sm ${isRightSidebarOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <RightSidebar 
                  onToggleRightSidebar={toggleRightSidebar} 
